...
<nav
  class="sticky top-0 space-x-4 dark:bg-zinc-800 bg-gray-300 px-4 py-3 lg:space-x-6"
>
  <ul class="flex items-center justify-between">
    ...
    {#if !activeUrl.startsWith("/swimming")}
      ...
      <div
        class="md:display-block hidden space-x-4 md:flex md:items-center lg:space-x-6"
      >
