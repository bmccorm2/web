...
>
	<div class="flex flex-col sm:flex-row">
		...
		{:else}
			<div class="flex h-36 w-full shrink-0 items-center justify-center bg-sky-50 text-sky-600 sm:h-auto sm:w-40 md:w-48 dark:bg-slate-800 dark:text-slate-600">
		...
		<div class="flex flex-1 flex-col p-4 sm:p-5">
			<div class="mb-2 flex items-start justify-between gap-2">
				...
				<div class="flex items-center gap-3">
					...
					>
						<Trash2
							class="size-4 cursor-pointer text-red-500 disabled:cursor-not-allowed disabled:opacity-50 hover:text-red-600"
						/>
					</button>
				</div>
			</div>
